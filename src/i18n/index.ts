...
const resources = {
  en: {
    translation: {
      ...
      insightsIntoProgress: "Insights into your goal progress and achievements",
      refresh: "Refresh",
      ...
      goalsWithDeadlines: "Goals with Deadlines",
      overdueGoals: "Overdue Goals",
      onTimeCompletionRate: "On-time Completion Rate",
      activitySummary: "Activity Summary",
      averageGoalsPerMonth: "Average Goals per Month",
      averageTasksPerGoal: "Average Tasks per Goal",
      ...
      noCategoriesFound: "No categories found. Create some goals to see category performance!",
      keepItUp: "Keep it up!",
  ...
  th: {
    translation: {
      ...
      // Analytics
      analyticsDashboard: "แดชบอร์ดการวิเคราะห์",
      insightsIntoProgress: "ข้อมูลเชิงลึกเกี่ยวกับความคืบหน้าและความสำเร็จของคุณ",
      refresh: "รีเฟรช",
      goalCompletion: "การเสร็จสิ้นเป้าหมาย",
      ...
      keepItUp: "ทำต่อไป!",
      startYourStreak: "เริ่มสตรีคของคุณ!",
      activeGoals: "เป้าหมายที่ใช้งานอยู่",
      overview: "ภาพรวม",
      trends: "แนวโน้ม",
      categories: "หมวดหมู่",
      monthlyActivity: "กิจกรรมรายเดือน",
      lastTwelveMonths: "12 เดือนที่ผ่านมา",
      goalsCreated: "เป้าหมายที่สร้าง",
      goalsCompleted: "เป้าหมายที่เสร็จสิ้น",
      tasksCompleted: "งานที่เสร็จสิ้น",
      completionTrends: "แนวโน้มการเสร็จสิ้น",
      timelineAnalysis: "การวิเคราะห์ไทม์ไลน์",
      goalsWithDeadlines: "เป้าหมายที่มีกำหนดเวลา",
      overdueGoals: "เป้าหมายที่เกินกำหนด",
      onTimeCompletionRate: "อัตราการเสร็จสิ้นตรงเวลา",
      activitySummary: "สรุปกิจกรรม",
      averageGoalsPerMonth: "เป้าหมายเฉลี่ยต่อเดือน",
      averageTasksPerGoal: "งานเฉลี่ยต่อเป้าหมาย",
      favoriteGoals: "เป้าหมายโปรด",
      categoryComparison: "การเปรียบเทียบหมวดหมู่",
      totalGoals: "เป้าหมายทั้งหมด",
      completedGoals: "เป้าหมายที่เสร็จสิ้น",
      remaining: "เหลืออยู่",
      excellent: "ยอดเยี่ยม",
      good: "ดี",
      needsFocus: "ต้องให้ความสนใจ",
      noCategoriesFound: "ไม่พบหมวดหมู่ สร้างเป้าหมายเพื่อดูประสิทธิภาพตามหมวดหมู่!",
      keepItUp: "ทำต่อไป!",
